...
define Package/$(PKG_NAME)
	...
	PKGARCH:=all
	DEPENDS:=+shadowsocksr-libev-alt +ipset +ip-full +iptables-mod-tproxy +dnsmasq-full +coreutils +coreutils-base64 +pdnsd-alt +wget +lua +luasocket +jshn +ipt2socks +microsocks \
